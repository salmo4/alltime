...
<div class="container">
  ...
  <p>
    Your user ID =   <b> <?php echo e(Auth::user()->id); ?> </b>  You can install Service for Multi Vendor Auction  WordPress widget.
    Open your WordPress site Appearance page > Side bar > Multi Vendor Auction  widget and change the number to your user ID.
     <a href='https://wordpress.org/plugins/service-for-multi-vendor-auction/' target='_blank'>https://wordpress.org/plugins/service-for-multi-vendor-auction/</a>
    </p>    
