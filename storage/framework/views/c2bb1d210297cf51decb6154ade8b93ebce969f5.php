    ...
    $(function() {
        ...
        if (current_images_str != "") {
            ...
            for (var i = 0; i < images_strArr.length; i++) {
                if (images_strArr[i] != "") {
                    strFoo = "<div><img id='" + images_strArr[i].slice(0, -4) + "' src='<?php echo e(URL::to('/uploads/products/thumbs/small/')); ?>/" + images_strArr[i] + "' /><input type='button' id='deletebtn-" + productid + "-" + images_strArr[i] + "'  value='X' /></div>";
            ...
            init: function() {
                this.on("success", function(file, responseText) {
                    ...
                    if (responseText != 'filenotvalid') {
                        ...
                        strFoo = "<div><img id='" + responseText.slice(0, -4) + "' src='<?php echo e(URL::to('/uploads/products/originals')); ?>/" + responseText.substr(0, n) + "' /><input type='button' id='deletebtn-" + productid + "-" + responseText + "'    value='X'  /></div>";
...
<!--
    ...
    <div class="alert alert-success">
        <?php echo e(trans('c.The modification is saved.')); ?> 
    </div>
    <?php endif; ?>
    -->
<!--
...
-->
    ...
    <br style="clear:both;">
    <br>  <br>
    <?php echo e(Form::model($product, array('route' => array('product.postedit', $product->id), 'files'=> true, 'id'=>'product_edit_form'))); ?>	

    <?php echo e(Form::hidden('id', $product->id, [ 'id' => 'productid' ])); ?>
    ...
    <div class='form-group'>
        ...
        <?php echo e(Form::hidden('images_str', $images_str, [ 'id' => 'images_str', 'style'=>'width:400px;'])); ?>
...
<!--
    <div class='form-group'>
        ...
        <?php echo e(Form::checkbox('fix_price_status', null)); ?>
