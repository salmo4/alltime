...
<br> <a href="{{ URL::to('arrived_orders')}}">  Back to the Orders</a> <br>
    ...
    <div class="menu">
        ...
        <table class="table table-striped table-condensed">
            ...
            <tr><td>Delete order: </td><td>        <a  href="{{ URL::to('order_delete/'.$key) }}"  onclick="if (!confirm('Are you sure to delete this order?')) {
                        return false;
                    }
                    ;">  
                        {{  trans('c.delete') }}
