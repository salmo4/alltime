	...
	<div class="row">
        ...
        <div class="navbar  navbar-fixed-bottom"  style="background-color: #fff;">
            <div class="container">
                ...
                <a href="https://www.facebook.com/salmo.samy" target='_blank' class="navbar-btn btn-sm pull-right" style=' background: #e5e338;color:black'>
                    <i class="fa fa-download fa-2x " ></i> Created by Samuel Gui</a>
            </div>
