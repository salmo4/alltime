...
<div class="container">
    ...
    <div class="row">
        ...
        <ul class="thumbnails ">
            ...
            <li class="thumbnail col-md-3 col-sm-4 col-xs-8 card add_shadow " style="min-height:290px; @if($product->confirm ==0)border:1px solid red; @endif">
                ...
                <div style="padding:10px;">
                  ...
                  <a  class="btn btn-success" style="line-height: 20px;" href="{{ URL::to('product/edit/'.$product->id) }}" >  
                    ...
                    <a  class="btn btn-danger " style="line-height: 20px;" href="{{ URL::to('product/delete/'.$product->id) }}"  onclick="if (!confirm('Are you sure to delete this auction?')) {
                                return false;
                            }
                            ;">  
                        Delete
