    ...
    <?php if($lang == "ro"): ?>
        <div class="panel-category marginTop40">
            ...
            <div id="first" class="panel-content hidden">
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/add-item.png')); ?>">
                <p>
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/save-item.png')); ?>">
            </div>
        </div>
        <div class="panel-category">
            ...
            <div id="second" class="panel-content hidden">
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/admin-messages.png')); ?>">
                <p>
        ...
        <div class="panel-category">
            ...
            <div id="second2" class="panel-content hidden">
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/add-user.png')); ?>">
            </div>
        </div>
        <div class="panel-category">
            <div class="panel-header">
            ...
            <div id="third" class="panel-content hidden">
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/search.png')); ?>">
                <p>
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/message.png')); ?>">
            </div>
        </div>
        <div class="panel-category">
            <div class="panel-header">
            ...
            <div id="fourth" class="panel-content hidden">
                ...
                <img src="<?php echo e(URL::asset('/img/help-img/calendar.png')); ?>">
                <p>
