            ...
            <div class="container">
                ...
                <ul class="nav navbar-nav ">
                   ...
                   <!--
                    ...
                    -->
                    <li> <a  href="<?php echo e(URL::to('pub_bid_list')); ?>"><i class="fa fa-list fa-1x " ></i> <?php echo e(trans('c.Items')); ?></a></li>
                    ...
                    <li><a href="<?php echo e(URL::to('user/login')); ?>"><i class="fa fa-pencil fa-1x " ></i> Log in</a></li>
                        <li><a href="<?php echo e(URL::to('help-contact')); ?>"><i class="fa fa-info fa-1x " ></i> <?php echo e(trans('c.help-contact')); ?></a></li>
                ...
                <ul class="nav navbar-nav ">
                    ...
                    <?php if( $application_type ==1): ?>
                    <li class="divider-vertical"></li>
                    <li><a href="<?php echo e(URL::to('mainbids')); ?>"><i class="fa fa-legal fa-1x " ></i><?php echo e(trans('c.My Products')); ?></a></li>
                    <?php endif; ?>

                   
                    <?php if( $application_type ==1): ?>
                    <li class="divider-vertical"></li>
                    <li><a href="<?php echo e(URL::to('basket/basketfull')); ?>"><i class="fa fa-cart-arrow-down fa-1x " ></i>  <?php echo e(trans('c.Basket (Your Winning Bids)')); ?></a></li>
                
                    <li class="divider-vertical"></li>
                    <li><a href="<?php echo e(URL::to('arrived_orders')); ?>">  <?php echo e(trans('c.Orders')); ?></a></li>
                    <?php endif; ?>
...
<div class="container">
	...
	<div class="row">
        <div class=" col-sm-offset-1 col-sm-2 ">
            <a  href="<?php echo e(URL::to('index')); ?>">    <img src="<?php echo e(URL::asset('/img/alltime.png')); ?>" > </a>
         </div>
        <div class="col-sm-6">
        ...
        <div class="navbar  navbar-fixed-bottom footer"  style="background-color: #fff;">
            <div class="container">
                <div class="paddingY10">
                    <a href="https://www.facebook.com/salmo.samy" target='_blank' class="navbar-btn btn-sm sm-icon" style=' background: #e5e338;color:black'>
                ...
                <span>
                    ...
                    <a href="https://www.facebook.com/salmo.samy" target='_blank' class="navbar-btn btn-sm sm-icon" style=' background: #0078D7;color:#fff'>
                ...
                <div class="col-lg-12 top-delimiter paddingY20">
                    <div class="row">
                        ...
                        <ul class="footer-menu  pull-right">
                            <li><a  href="<?php echo e(URL::to('index')); ?>/1"><?php echo e(trans('c.Auction')); ?></a></li>
                            <li> <a  href="<?php echo e(URL::to('pub_bid_list')); ?>"><?php echo e(trans('c.Items')); ?></a></li>
                            <li><a href="<?php echo e(URL::to('user/create')); ?>"><?php echo e(trans('c.Registration')); ?></a></li>
                            <li><a href="<?php echo e(URL::to('user/login')); ?>"> LOG IN</a></li>
                        </ul>
                    </div>
                </div>
            </div>
